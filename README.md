...
Hello! I'm **Cliff**, an **ISTQB Certified Software Quality Assurance Engineer** passionate about building reliable solution software through structured testing, system analysis, continuous improvement and development.
...
- Currently building **AI Agents** and **AI Skills** that aims to assist SQA Engineers in every testing process and activities.
...
2. **Test Scenario Design**  
   Identify complete user journeys, requirements and critical system paths.
...
- **AI/ML development for test automation use cases**
...
- Improving **test automation script maintainable, scalable and reliable**
